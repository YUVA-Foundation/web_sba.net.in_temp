                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="<?php echo (($this->uri->segment(1) == 'dashboard') ? "active" : null) ?>">
                         ...
                         <li class="<?php echo (($this->uri->segment(1) == 'home#') ? "active" : null) ?>">
                            <a href="#" id="showReg">
                           <i class="fa fa-hospital-o"></i> <?php echo ('Hospital') ?> </a>
                        </li> 
...
$(document).ready(function(){
  ...
  $("#showReg").click(function(){
    ...
    $("#registration1").slideToggle();
  });
});
</script>
                          <li class="treeview <?php echo (($this->uri->segment(1) == "registration") ? "active" : null) ?>" id="registration">
                             <a href="<?php echo base_url('registration/general_info') ?>">
                                <i class="fa fa-university"></i> <span><?php echo "Registration"; ?></span>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url("registration/general_info") ?>"><i class="fa fa-info-circle" aria-hidden="true"><?php echo " "."General Information"; ?></i></a></li>
                                 <li><a href="<?php echo base_url("registration/statutory_compliance") ?>"><?php echo ('Statutory Compliance'); ?></a></li> 
                                <li><a href="<?php echo base_url("registration/hospital_staffing") ?>"><?php echo ('Hospital Staffing'); ?></a></li> 
                                <li><a href="<?php echo base_url("registration/clinical_services_details") ?>"><?php echo ('Clinical Services Details'); ?></a></li> 
                                <li><a href="<?php echo base_url("registration/physical_infrastructure") ?>"><?php echo ('Physical Infrastructure'); ?></a></li> 
                                <li><a href="<?php echo base_url("toolkit/chapterone") ?>"><?php echo ('SELF ASSESSMENT TOOLKIT'); ?></a></li> 
                               <!--  <li><a href="<?php echo base_url("department") ?>"><?php echo ('Documentation'); ?></a></li> 
                                <li><a href="<?php echo base_url("department") ?>"><?php echo ('Location'); ?></a></li>  -->
                            </ul>
                        </li>

                        <li class="treeview <?php echo (($this->uri->segment(1) == "chapterone") ? "active" : null) ?>" id="registration1">
                             <a href="<?php echo base_url('toolkit/chapterone') ?>">
                                <i class="fa fa-university"></i> <span><?php echo "Self assessment toolkit "; ?></span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url("toolkit/chapterone") ?>"><?php echo ('Chapter 1  '); ?></a></li> 
                                <li><a href="<?php echo base_url("toolkit/chaptertwo") ?>"><?php echo ('Chapter 2  '); ?></a></li>
                                <li><a href="<?php echo base_url("toolkit/chapterthree") ?>"><?php echo ('Chapter 3  '); ?></a></li> 
                                <li><a href="<?php echo base_url("toolkit/chapterfour") ?>"><?php echo ('Chapter 4  '); ?></a></li>
                                <li><a href="<?php echo base_url("toolkit/chapterfive") ?>"><?php echo ('Chapter 5  '); ?></a></li>
                                <li><a href="<?php echo base_url("toolkit/chaptersix") ?>"><?php echo ('Chapter 6  '); ?></a></li>
                                <li><a href="<?php echo base_url("toolkit/chapterseven") ?>"><?php echo ('Chapter 7  '); ?></a></li>
                                <li><a href="<?php echo base_url("toolkit/chaptereight") ?>"><?php echo ('Chapter 8  '); ?></a></li>
                                <li><a href="<?php echo base_url("toolkit/chapternine") ?>"><?php echo ('Chapter 9  '); ?></a></li>
                                 <li><a href="<?php echo base_url("toolkit/chapterten") ?>"><?php echo ('Chapter 10  '); ?></a></li>
                ...
                <section class="content-header">
                    ...
                    <div class="p-l-30 p-r-30">
                        ...
                        <div class="header-title">
                            <h1><?php if(isset($main_title)){
                              echo ucfirst($main_title);
                            } else {
                                   echo str_replace('_', ' ', ucfirst($this->uri->segment(1))); 
                               }
                                ?></h1>
