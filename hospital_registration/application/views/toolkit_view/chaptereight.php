...
<div class="row">
    <!--  table area -->
    <?php  echo form_open_multipart('toolkit/chaptereight','class="form-inner"') ?>
    ...
    <div class="col-sm-12">
        ...
        <h3><b>FMS.1: Uniform care to patients is provided in all settings of the organisation and is guided by the applicable laws, regulations and guidelines.</b></h3>
         </label>
      </div> 
